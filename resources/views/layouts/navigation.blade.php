        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('autobuses.index')" :active="request()->routeIs('autobuses.index')">
                        {{ __('Autobuses') }}
                    </x-nav-link>
                    <x-nav-link :href="route('conductors.index')" :active="request()->routeIs('conductors.index')">
                        {{ __('Conductores') }}
                    </x-nav-link>
