    ...
    <div>
        <table>
            <thead>
                <tr>
                    <th>Salida Cañada</th>
                    <th>LLegada Centro</th>
                    <th>Salida Centro</th>
                    <th>LLegada Cañada</th>
                    <th>Autobus</th>
                    <th>Conductor</th>
            ...
            <tbody>
                @foreach ($horario as $horarios)
                    <tr>
                        <td>{{ $horarios->hora_salida_canada }}</td>
                        <td>{{ $horarios->hora_llegada_centro }}</td>
                        <td>{{ $horarios->hora_salida_centro }}</td>
                        <td>{{ $horarios->hora_llegada_canada }}</td>
                        <td>{{ $horarios->autobus->marca }}</td>
                        <td>{{ $horarios->conductor->nombreCompleto }}</td>
                        <td>{{ $horarios->updated_at->format('d/m/y') }}</td>
                        <td>{{ $horarios->created_at->format('d/m/y') }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
