                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center justify-between">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-white">{{ __('Editar') }} al Conductor</h1>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="max-w-lg mx-auto">
                                ...
                                <form method="POST" action="{{ route('conductors.update', $conductor->id) }}"  role="form" enctype="multipart/form-data">
                                    {{ method_field('PATCH') }}
                                    @csrf
